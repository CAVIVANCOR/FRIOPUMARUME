...
import MapView from "./about/MapView";
const Contact = () => {
    const styles = {
        contentDesktop: {
            top: 0,
    ...
    return (
        <Box id="product" component="main" 
            ...
            <Box sx={styles.contentDesktop}>
                <Typography variant="h4" sx={{ minWidth: '100%', textAlign: 'center', paddingTop: '10px', backgroundColor:'#154A7D', color: '#FFFFFF' }}>Contactenos</Typography>
            </Box>
            <Box sx={styles.contentMobile}>
                <Typography variant="h6" sx={{ backgroundColor:'#154A7D', color: '#FFFFFF' }}>Contactenos</Typography>
            </Box>
            <Divider />
            <MapView />
        </Box>
